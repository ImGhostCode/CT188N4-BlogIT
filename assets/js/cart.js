...
function showCart() {
    ...
    if (cart.length == 0) {
        ...
        for (const id of cart) {
            ...
            <a href="#" class="cart-item__link">${Courses[id].title}</a>
            <p class="cart-item-author">By ${Courses[id].author}</p>
            <p class="cart-item-rating">
            <span style="color: #b4690e;">${Courses[id].rate}</span>
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
            <i class="fa-solid fa-star"></i>
            ${Courses[id].rate > 4.7 ? '<i class="fa-solid fa-star"></i>' : '<i class="fa-solid fa-star-half-stroke"></i>'} 
            <span class="item-rate-number">(${Courses[id].rate_number} ratings)</span>
            </p>
            </div>
            <div class="cart-item-price-wrapper">
            <p class="cart-item-price-sale">${VNDConverter(Courses[id].sale)} <i style="color: rgb(135, 16, 216);" class="fa-solid fa-tag"></i></p>
            <p class="cart-item-price">${VNDConverter(Courses[id].price)}</p>
            </div>
